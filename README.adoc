...
- https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/data-sources/service[kubernetes_service.ray] (data source)
...
|[[output_cluster_dns]] <<output_cluster_dns,cluster_dns>> |Ray cluster dns
|[[output_cluster_ip]] <<output_cluster_ip,cluster_ip>> |Ray cluster ip internal
|[[output_endpoint]] <<output_endpoint,endpoint>> |Ray endpoint external
|===
// END_TF_TABLES
====
